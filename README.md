...
* O objetivo é oferecer um IDE de desktop funcional para desenvolvimento em dispositivos móveis, utilizando o {:target="_blank" rel="noopener"}<a href="https://github.com/termux/termux-app" target="_blank" rel="noopener noreferrer">Termux</a> e o [Termux:X11](https://github.com/termux/termux-x11).
## Funcionalidades
