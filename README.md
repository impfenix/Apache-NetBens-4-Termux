...
* O objetivo é oferecer um IDE de desktop funcional para desenvolvimento em dispositivos móveis, utilizando o [Termux](https://github.com/termux/termux-app){:target="_blank" rel="noopener"} e o [Termux:X11](https://github.com/termux/termux-x11).
## Funcionalidades
