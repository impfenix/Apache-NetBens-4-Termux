...
3 Apache NetBeans 4 Termux <img src="./icon/android-icon.png" width="45" alt="Ícone do Android">
...
Funcionalidades
Instalador Simples: Um pacote .apk <img src="./icon/icon.png" width="25" alt="Ícone do Instalador"> netbeans-termux-installer.apk que, quando aberto com o Termux, instala o Apache NetBeans automaticamente.
